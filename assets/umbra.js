...
(function () {
  ...
  const COMMANDS = [
    ...
    /* AUTO:articles START */
    { group: "Articles", label: "Your MSP's RMM Is Your Attack Surface", hint: "N-central + third-party risk", icon: "fa-network-wired", href: "research/n-able-ncentral-msp-supply-chain.html", keywords: "n-able n-central rmm msp managed service provider supply chain third party risk cve-2026-18556 cve-2026-18577 authentication bypass cwe-288 cisa kev take control cloudflared cloudflare tunnel svchost masquerading persistence essential eight patch applications mfa supplier assurance australian smb sigma t1036.005 t1543.003 t1572" },
    ...
    { group: "Articles", label: "Securing AI Agents", hint: "tool-calling LLMs", icon: "fa-robot", href: "research/securing-ai-agents.html", keywords: "ai agents agentic tool calling function calling excessive agency llm06 mcp model context protocol confused deputy indirect prompt injection lethal trifecta atlas autonomy human in the loop guardrails camel dual llm" },
    { group: "Articles", label: "Detecting the LiteLLM Command Injection", hint: "CVE-2026-42271", icon: "fa-bug", href: "research/detecting-litellm-command-injection.html", keywords: "litellm cve-2026-42271 command injection rce mcp ai gateway proxy cisa kev starlette badhost cve-2026-48710 sigma t1190 berriai" },
